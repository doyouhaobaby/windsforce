...
return array(
	...
	'CACHE_REPLACE_CHILDREN'=>FALSE,// 模板编译是否将子模板的缓存写入父模板以达到降低IO开销
	...
	'TMPL_VAR_IDENTIFY'=>'array',// 为空表示模板解析自动识别为obj,array
	'AUTO_ACCEPT_LANGUAGE'=>TRUE,// 自动侦测语言
	'QEEPHP_AUTH_KEY'=>'qeephp_auth_key',// 安全key
	...
	'COOKIE_PREFIX'=>'qeephp_',// cookie前缀
	...
	'RUNTIME_CACHE_TIMES'=>array(),// 缓存时间预植,键值=缓存值，键值不带前缀 array('option'=>60)
	'RUNTIME_FILECACHE_PATH'=>'',// 文件缓存路径
	...
	'LANG_ON'=>TRUE,// 是否使用语言包
	'LANG_SWITCH'=>TRUE,// 是否允许切换语言包
	'LANG'=>'zh-cn',// 当前语言环境
	'URL_DOMAIN_ON'=>true,// 是否开启域名
	'URL_DOMAIN'=>'',// 域名，不为空将会被写入到生成的网址中，后面不能添加‘/’，如 http://qeephp.114.ms
	'_ROUTER_'=>array(),// 路由配置
	'DOMAIN_ON'=>FALSE,// 是否开启多域名
	'DOMAIN_TOP'=>'',// 顶级域名，如 qeephp.114.ms
	'DOMAIN_SUFFIX'=>'',// 子目录
	'U_PRO_VAR'=>'D',// URL生成受保护参数
