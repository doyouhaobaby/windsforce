...
(1, 'home', '个人空间', '1.0', '个人空间应用', 'http://qeephp.114.ms', 'admin@qeephp.114.ms', 'WindsForce Team', 'http://qeephp.114.ms', 1, 1, 1, 1, 1, 1),
(2, 'wap', 'Wap手机', '1.0', '手机应用', 'http://qeephp.114.ms', 'admin@qeephp.114.ms', 'WindsForce Team', 'http://qeephp.114.ms', 1, 1, 1, 1, 1, 1);
...
(2, 1355151005, 0, 'WindsForce', 'http://windsforce.114.ms', '风动社区', '{__PUBLIC__.''/images/common/iconlogo/logo.gif''}', 1, 0, 1);
...
(1, 1355499576, 0, 1, 'admin', '理想很丰满，现实很骨感！', 1, '127.0.0.0', 0, 0, 1, '', '');
...
(4, 0, '关于我们', 'aboutus', '', 'www~@homesite/aboutus', 0, 0, '', 2, 1, 0, 0, ''),
(5, 0, '联系我们', 'contactus', '', 'www~@homesite/contactus', 0, 0, '', 2, 1, 0, 0, ''),
(6, 0, '用户协议', 'agreement', '', 'www~@homesite/agreement', 0, 0, '', 2, 1, 0, 0, ''),
(7, 0, '隐私声明', 'privacy', '', 'www~@homesite/privacy', 0, 0, '', 2, 1, 0, 0, ''),
(1, 0, '帮助', 'help', '', 'www~@homehelp/index', 0, 0, '', 2, 1, 0, 0, ''),
...
(45, 'home@ucenter@add_homefresh|post', '发布新鲜事', 1, '', 0, 50, 3, 0, 1362712136, 1362886478, 1),
...
(93, 'groupgrouptopicadminaudittopic_dialog|audittopic', '帖子审核', 1, '', 0, 71, 3, 0, 1402732795, 0, 1);
...
('site_description', '风动社区 (To Make Prowerful APP)'),
('site_url', ''),
('close_site', '0'),
...
('icp', ''),
('home_description', '{site_name}是一个以社区为核心的APP开发框架。在这里你可以我们可以实现产品跨界融合，充分利用APP独立的模式来为网站提供无限动力，我们崇尚的是理念：<span>简单与分享</span>。'),
...
('windsforce_program_company', '风动（成都）'),
('image_max_width', '800'),
('slide_duration', '0.3'),
('slide_delay', '5'),
('mail_default', ''),
...
(1, 0, '欢迎加入', '{Q::U(''home://public/register'')}', '{__PUBLIC__.''/images/common/slidebox/1.jpg''}', 1, 1345357086, 1345364471, 1),
(2, 0, '立刻登录', '{Q::U(''home://public/login'')}', '{__PUBLIC__.''/images/common/slidebox/2.jpg''}', 1, 1345357086, 0, 1),
(3, 0, '关于我们', '{Q::U(''home://homesite/aboutus'')}', '{__PUBLIC__.''/images/common/slidebox/3.jpg''}', 1, 1345357086, 0, 1);
...
('userprofile_windsforce', 1, '风动', '', 0, 0, 0, 0, 1),
